...
def interference_generation(s1_rx_ant1, num_interferers, h21, h22, L, channel_idx, modem, len_tx_burst, seed, osr=1):
    ...
    for _ in range(num_interferers):
        ...
        interf_bits = generate_data_bits(len_tx_burst, seed)
